...
namespace Chraft.PluginSystem
{
    ...
    {
        EventListener RegisterEvent(Event Event, IChraftListener Listener, IPlugin Plugin);
        void UnregisterEvent(Event Event, IChraftListener Listener, IPlugin Plugin);
        ...
        void CallEvent(Event Event, ChraftEventArgs args);
    }
}