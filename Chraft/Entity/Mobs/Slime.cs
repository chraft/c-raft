...
namespace Chraft.Entity.Mobs
{
    public class Slime : Mob
    {
        ...
        protected override void DoDeath(EntityBase killedBy)
        {
            ...
            if (count > 0)
                Server.DropItem(World, UniversalCoords.FromWorld(Position.X, Position.Y, Position.Z), new Interfaces.ItemStack((short)Chraft.World.BlockData.Items.Slime_Ball, count, 0));
        }
    }
}
