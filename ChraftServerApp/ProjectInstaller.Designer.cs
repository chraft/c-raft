namespace ChraftServer
{
	partial class ProjectInstaller
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.mainServiceInstaller.Description = "C#raft Minecraft Server";
			this.mainServiceInstaller.DisplayName = "C#raft Server";
			this.mainServiceInstaller.ServiceName = "ChraftServer";
